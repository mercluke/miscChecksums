...
#define INCLUDE_DESMUME_FOOTER (1)
...
uint8_t desmume_footer[] = {
	...
	0x74,0x61,0x20,0x66, 0x6F,0x6F,0x74,0x65, 0x72,0x3A,0xA1,0x78, 
	0x02,0x00,0x00,0x00, 0x04,0x00,0x05,0x00, 0x00,0x00,0x03,0x00,
	0x00,0x00,0x00,0x00, 0x04,0x00,0x00,0x00, 0x00,0x00,0x7C,0x2D, 
	0x44,0x45,0x53,0x4D, 0x55,0x4D,0x45,0x20, 0x53,0x41,0x56,0x45, 
	0x2D,0x7C
};
uint32_t desmume_footer_length = 122;
...
int main(int argc, char **argv)
{
	...
	if(INCLUDE_DESMUME_FOOTER) {
		for(i = 0; i < desmume_footer_length; i++) {
			fputc(desmume_footer[i], output);
		}
	}
